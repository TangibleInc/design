        ...
        <Theme asChild>
          <ContextMenuPrimitive.Content
            ...
            className={classNames(
              't-PopperContent',
              't-BaseMenuContent',
              't-ContextMenuContent',
              className
            )}
          >
            <ScrollArea type="auto">
              <div className={classNames('t-BaseMenuViewport', 't-ContextMenuViewport')}>
...
const ContextMenuLabel = React.forwardRef<ContextMenuLabelElement, ContextMenuLabelProps>(
  ({ className, ...props }, forwardedRef) => (
    <ContextMenuPrimitive.Label
      ...
      asChild={false}
      ref={forwardedRef}
      className={classNames('t-BaseMenuLabel', 't-ContextMenuLabel', className)}
    />
  )
);
  ...
  (props, forwardedRef) => {
    ...
    return (
      <ContextMenuPrimitive.Item
        ...
        {...itemProps}
        ref={forwardedRef}
        className={classNames('t-reset', 't-BaseMenuItem', 't-ContextMenuItem', className)}
      >
        <Slottable>{children}</Slottable>
        {shortcut && <div className="t-BaseMenuShortcut t-ContextMenuShortcut">{shortcut}</div>}
      </ContextMenuPrimitive.Item>
    );
  }
);
...
const ContextMenuGroup = React.forwardRef<ContextMenuGroupElement, ContextMenuGroupProps>(
  ({ className, ...props }, forwardedRef) => (
    <ContextMenuPrimitive.Group
      ...
      asChild={false}
      ref={forwardedRef}
      className={classNames('t-BaseMenuGroup', 't-ContextMenuGroup', className)}
    />
  )
);
...
>(({ className, ...props }, forwardedRef) => (
  <ContextMenuPrimitive.RadioGroup
    ...
    asChild={false}
    ref={forwardedRef}
    className={classNames('t-BaseMenuRadioGroup', 't-ContextMenuRadioGroup', className)}
  />
));
  ...
  return (
    <ContextMenuPrimitive.RadioItem
      ...
      className={classNames(
        ...
        't-BaseMenuRadioItem',
        't-ContextMenuItem',
        't-ContextMenuRadioItem',
        className
      )}
    >
      <Slottable>{children}</Slottable>
      <ContextMenuPrimitive.ItemIndicator className="t-BaseMenuItemIndicator t-ContextMenuItemIndicator">
  ...
  return (
    <ContextMenuPrimitive.SubTrigger
      ...
      className={classNames(
        ...
        't-ContextMenuItem',
        't-ContextMenuSubTrigger',
        className
      )}
    >
      {children}
      <div className="t-BaseMenuShortcut t-ContextMenuShortcut">
        <ThickChevronRightIcon className="t-BaseMenuSubTriggerIcon t-ContextMenuSubTriggerIcon" />
      </div>
    </ContextMenuPrimitive.SubTrigger>
  );
});
...
>(({ className, ...props }, forwardedRef) => (
  <ContextMenuPrimitive.Separator
    ...
    asChild={false}
    ref={forwardedRef}
    className={classNames('t-BaseMenuSeparator', 't-ContextMenuSeparator', className)}
  />
));
