    ...
    return (
      <SelectPrimitive.Trigger asChild>
        <button
          ...
          {...triggerProps}
          ref={forwardedRef}
          className={classNames('t-reset', 't-SelectTrigger', className)}
        >
          <span className="t-SelectTriggerInner">
            <SelectPrimitive.Value placeholder={placeholder}>{children}</SelectPrimitive.Value>
          </span>
          <SelectPrimitive.Icon asChild>
            <ChevronDownIcon className="t-SelectIcon" />
        ...
        <Theme asChild>
          <SelectPrimitive.Content
            ...
            className={classNames(
              { 't-PopperContent': contentProps.position === 'popper' },
              't-SelectContent',
              className
            )}
          >
            <ScrollAreaPrimitive.Root type="auto" className="t-ScrollAreaRoot">
              <SelectPrimitive.Viewport asChild className="t-SelectViewport">
              ...
              <ScrollAreaPrimitive.Scrollbar
                className="t-ScrollAreaScrollbar t-r-size-1"
...
const SelectItem = React.forwardRef<SelectItemElement, SelectItemProps>((props, forwardedRef) => {
  ...
  return (
    <SelectPrimitive.Item
      ...
      asChild={false}
      ref={forwardedRef}
      className={classNames('t-SelectItem', className)}
    >
      <SelectPrimitive.ItemIndicator className="t-SelectItemIndicator">
        <ThickCheckIcon className="t-SelectItemIndicatorIcon" />
...
const SelectGroup = React.forwardRef<SelectGroupElement, SelectGroupProps>(
  ({ className, ...props }, forwardedRef) => (
    <SelectPrimitive.Group
      ...
      asChild={false}
      ref={forwardedRef}
      className={classNames('t-SelectGroup', className)}
    />
  )
);
...
const SelectLabel = React.forwardRef<SelectLabelElement, SelectLabelProps>(
  ({ className, ...props }, forwardedRef) => (
    <SelectPrimitive.Label
      ...
      asChild={false}
      ref={forwardedRef}
      className={classNames('t-SelectLabel', className)}
    />
  )
);
...
const SelectSeparator = React.forwardRef<SelectSeparatorElement, SelectSeparatorProps>(
  ({ className, ...props }, forwardedRef) => (
    <SelectPrimitive.Separator
      ...
      asChild={false}
      ref={forwardedRef}
      className={classNames('t-SelectSeparator', className)}
    />
  )
);
