  ...
  (props, forwardedRef) => {
    ...
    return (
      <Comp
        ...
        {...rootProps}
        className={classNames('t-CalloutRoot', className)}
        ref={forwardedRef}
      >
...
const CalloutIcon = React.forwardRef<CalloutIconElement, CalloutIconProps>(
  ({ className, ...props }, forwardedRef) => {
    return (
      <div {...props} className={classNames('t-CalloutIcon', className)} ref={forwardedRef} />
    );
  }
);
  ...
  ({ className, ...props }, forwardedRef) => {
    ...
    return (
      <Text
        ...
        asChild={false}
        ref={forwardedRef}
        className={classNames('t-reset t-CalloutText', className)}
      />
    );
  }
);
