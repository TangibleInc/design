  ...
  (props, forwardedRef) => {
    ...
    return (
      <div
        ...
        data-radius={radius}
        style={style}
        className={classNames('t-TextFieldRoot', className)}
        onPointerDown={(event) => {
          ...
          const isRightSlot = target.closest(`
            .t-TextFieldSlot[data-side='right'],
            .t-TextFieldSlot:not([data-side='right']) ~ .t-TextFieldSlot:not([data-side='left'])
          `);
      ...
      >
        <input
          ...
          className="t-reset t-TextFieldInput"
        />
        {children}
      </div>
    );
  ...
  (props, forwardedRef) => {
    ...
    return (
      <div
        ...
        {...slotProps}
        ref={forwardedRef}
        className={classNames('t-TextFieldSlot', className)}
      />
    );
  }
);
