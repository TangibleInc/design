...
This is a set of colors based on [Radix UI Colors](https://www.radix-ui.com/colors).

<Accents />

Colors can be imported separately as needed, even combined with other sets of colors. They're all optional and meant to be used for defining semantic tokens, such as theme and component variables.
