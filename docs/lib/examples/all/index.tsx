...
export default function Example({
  ...
  return (
    <>
      <header
        className={`${prefix}bd-header ${prefix}bg-dark ${prefix}py-3 ${prefix}d-flex ${prefix}align-items-stretch ${prefix}border-bottom ${prefix}border-dark`}
      >
        <div
          className={`${prefix}container-fluid ${prefix}d-flex ${prefix}align-items-center`}
        >
          <h1
            className={`${prefix}d-flex ${prefix}align-items-center ${prefix}fs-4 ${prefix}text-white ${prefix}mb-0`}
          >
            {/* <!-- <img src="../assets/brand/bootstrap-logo-white.svg" width="38" height="30" className={`${prefix}me-3`} alt="Example"> --> */}
            All Components
          </h1>
          {/* <!-- <a href="../examples/all-rtl/" className={`${prefix}ms-auto ${prefix}link-light`} hrefLang="ar">RTL all</a> --> */}
        </div>
      </header>
      <aside
      ...
      >
        <h2
          className={`${prefix}h6 ${prefix}pt-4 ${prefix}pb-3 ${prefix}mb-4 ${prefix}border-bottom`}
        >
          On this page
        </h2>
      ...
      <div
        className={`${prefix}bd-all ${prefix}container-fluid ${prefix}bg-body`}
      >
        <section id='content'>
          <h2
        ...
        <section id='forms'>
          ...
          <article className={`${prefix}my-3`} id='overview'>
            <div
              className={`${prefix}bd-heading ${prefix}sticky-xl-top ${prefix}align-self-start ${prefix}mt-5 ${prefix}mb-3 ${prefix}mt-xl-0 ${prefix}mb-xl-2`}
            >
              <h3>Overview</h3>
          ...
          <article className={`${prefix}my-3`} id='sizing'>
            <div
              className={`${prefix}bd-heading ${prefix}sticky-xl-top ${prefix}align-self-start ${prefix}mt-5 ${prefix}mb-3 ${prefix}mt-xl-0 ${prefix}mb-xl-2`}
            >
              <h3>Sizing</h3>
              ...
              >
                ...
                >
                  ...
                  <div className={`${prefix}input-group`}>
                    <span className={`${prefix}input-group-text`}>
                      With textarea
                    </span>
                    <textarea
                      className={`${prefix}form-control`}
          ...
          <article className={`${prefix}my-3`} id='validation'>
            <div
              className={`${prefix}bd-heading ${prefix}sticky-xl-top ${prefix}align-self-start ${prefix}mt-5 ${prefix}mb-3 ${prefix}mt-xl-0 ${prefix}mb-xl-2`}
            >
              <h3>Validation</h3>
                  ...
                  <form className={`${prefix}row ${prefix}g-3`}>
                    <div className={`${prefix}col-md-4`}>
                      ...
                      <input
                        ...
                        required
                      />
                      <div className={`${prefix}valid-feedback`}>
                        Looks good!
                      </div>
                    </div>
                    <div className={`${prefix}col-md-4`}>
                    ...
                    <div className={`${prefix}col-md-4`}>
                      ...
                      <div
                        className={`${prefix}input-group ${prefix}has-validation`}
                      >
                        <span
                          className={`${prefix}input-group-text`}
              ...
              >
                ...
                >
                  <p className={`${prefix}h1`}>
                    Example heading{' '}
                    <span className={`${prefix}badge ${prefix}bg-primary`}>
                      New
                    </span>
                  </p>
                  ...
                  <p className={`${prefix}h3`}>
                    Example heading{' '}
                    <span className={`${prefix}badge ${prefix}bg-success`}>
                      New
                    </span>
                  </p>
                  <p className={`${prefix}h4`}>
                    Example heading{' '}
                    <span className={`${prefix}badge ${prefix}bg-danger`}>
                      New
                    </span>
                  </p>
                  ...
                  <p className={`${prefix}h6`}>
                    Example heading{' '}
                    <span className={`${prefix}badge ${prefix}bg-dark`}>
                      New
                    </span>
                  </p>
                </div>
            ...
            <div>
              ...
              >
                ...
                >
                  ...
                  <button
                    type='button'
                    className={`${prefix}btn ${prefix}btn-light`}
                  >
                    Light
                  </button>
                  <button
                    type='button'
                    className={`${prefix}btn ${prefix}btn-dark`}
                  >
                    Dark
                  </button>
                      ...
                      <div className={`${prefix}card`}>
                        <div className={`${prefix}row ${prefix}g-0`}>
                          ...
                          <div className={`${prefix}col-md-8`}>
                            <div className={`${prefix}card-body`}>
                              <h5 className={`${prefix}card-title`}>
                                Card title
                              </h5>
                              <p className={`${prefix}card-text`}>
                              ...
                              <p className={`${prefix}card-text`}>
                                <small
                                  className={`${prefix}text-body-secondary`}
                                >
                  ...
                  <div className={`${prefix}tab-content`} id='nav-tabContent'>
                    ...
                    >
                      <p>
                        ...
                        it with tabs, pills, and any other <code>.nav</code>
                        -powered navigation.
                      </p>
                    </div>
                    <div
              ...
              >
                ...
                >
                  <nav aria-label='Pagination example'>
                    <ul
                      className={`${prefix}pagination ${prefix}pagination-sm`}
                    >
